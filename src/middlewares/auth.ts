...
const verifyProductAuth = async (req: Request, res: Response, next: NextFunction) => {
...
const verifyArticleAuth = async (req: Request, res: Response, next: NextFunction) => {
...
const verifyProductCommentAuth = async (req: Request, res: Response, next: NextFunction) => {
...
const verifyArticleCommentAuth = async (req: Request, res: Response, next: NextFunction) => {
