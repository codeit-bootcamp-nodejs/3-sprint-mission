...
### 멘토에게
#### 시간 관계상 심화 요구사항을 미완료하였고 유저 정보 기능 중 유저가 자신이 등록한 상품의 목록을 조회하는 기능 구현에서 유저가 여러 개의 상품을 등록할 시 각각의 상품 목록을 조회하는 기능을 구현하지 못했습니다. 이 기능을 구현하는 법에 대해 조언을 주시면 감사하겠습니다.
